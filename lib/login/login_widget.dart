                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Screen_Shot_2025-02-10_at_10.33.38_PM.png',
                        ...
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              ...
                              indicatorColor: Color(0x005794F2),
                              tabs: [
                                Tab(
                                  text: 'Signup',
                                ),
                        ...
                        if (_model.tabBarCurrentIndex == 1)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.apiResultjgo =
                                  await InspirationalQuotesCall.call();

                              if ((_model.apiResultjgo?.succeeded ?? true)) {
                                FFAppState().Quote =
                                    InspirationalQuotesCall.quote(
                                  (_model.apiResultjgo?.jsonBody ?? ''),
                                )!;
                                FFAppState().Author =
                                    InspirationalQuotesCall.author(
                                  (_model.apiResultjgo?.jsonBody ?? ''),
                                )!;
                                safeSetState(() {});
                              } else {
